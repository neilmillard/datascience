...
# Clones ${FACTER_init_repouser}/${FACTER_init_reponame} and runs the puppet manifest
# to build using the ROLE and ENVIRONMENT.
...
set_facter() {
  local key=${1}
  #Note: The name of the environment variable is not the same as the facter fact.
